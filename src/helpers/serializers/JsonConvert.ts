...
const typeMapSeasons: any = {
    Season: o(
        [
            { json: "number", js: "number", typ: u(undefined, null, 0) },
            { json: "ids", js: "ids", typ: u(undefined, null, r("Ids")) },
            { json: "rating", js: "rating", typ: u(undefined, null, 3.14) },
            { json: "votes", js: "votes", typ: u(undefined, null, 0) },
            { json: "episode_count", js: "episodeCount", typ: u(undefined, null, 0) },
            { json: "aired_episodes", js: "airedEpisodes", typ: u(undefined, null, 0) },
            { json: "title", js: "title", typ: u(undefined, null, "") },
            ...
            { json: "network", js: "network", typ: u(undefined, null, "") },
